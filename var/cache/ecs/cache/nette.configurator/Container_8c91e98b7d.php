...
class Container_8c91e98b7d extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['0292', '0762', '0763', '0765']],
		...
		'PHPStan\Collectors\Collector' => [1 => ['0739', '0740', '0741', '0742', '0743', '0744', '0745', '0746', '0747']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['0761', '0764', '0766', '0767']],
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/var/www/var/cache/ecs/resultCache.php');
	}
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8c91e98b7d $container)
			{
		...
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/var/cache/ecs/resultCache.php',
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/var/cache/ecs/cache/PHPStan');
	}


	public function createServiceContainer(): Container_8c91e98b7d
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 5,
			'paths' => ['/var/www/app', '/var/www/tests', '/var/www/features/bootstrap'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'resultCachePath' => '/var/www/var/cache/ecs/resultCache.php',
			...
			'tmpDir' => '/var/www/var/cache/ecs',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/var/www/var/cache/ecs',
			...
			'env' => [
				...
				'DB_DSN' => 'pgsql:host=postgres;port=5432;dbname=main',
				'DB_PASS' => 'app',
				'TEST_DB_DSN' => 'sqlite:/var/www/tmp/identifier.sqlite',
				...
				'COLUMNS' => '180',
				'SHELL_VERBOSITY' => '0',
				'PHPSTAN_ORIGINAL_INIS' => ':/usr/local/etc/php/conf.d/docker-fpm.ini:/usr/local/etc/php/conf.d/docker-php-ext-bcmath.ini:/usr/local/etc/php/conf.d/docker-php-ext-gd.ini:/usr/local/etc/php/conf.d/docker-php-ext-intl.ini:/usr/local/etc/php/conf.d/docker-php-ext-mysqli.ini:/usr/local/etc/php/conf.d/docker-php-ext-opcache.ini:/usr/local/etc/php/conf.d/docker-php-ext-pdo_mysql.ini:/usr/local/etc/php/conf.d/docker-php-ext-pdo_pgsql.ini:/usr/local/etc/php/conf.d/docker-php-ext-sodium.ini:/usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini:/usr/local/etc/php/conf.d/docker-php-ext-zip.ini',
				'PHP_INI_SCAN_DIR' => '',
				'PHPRC' => '/tmp/j6d21mule1rb1hfJmnN',
				'XDEBUG_HANDLER_SETTINGS' => '/tmp/j6d21mule1rb1hfJmnN|1|*|*|:/usr/local/etc/php/conf.d/docker-fpm.ini:/usr/local/etc/php/conf.d/docker-php-ext-bcmath.ini:/usr/local/etc/php/conf.d/docker-php-ext-gd.ini:/usr/local/etc/php/conf.d/docker-php-ext-intl.ini:/usr/local/etc/php/conf.d/docker-php-ext-mysqli.ini:/usr/local/etc/php/conf.d/docker-php-ext-opcache.ini:/usr/local/etc/php/conf.d/docker-php-ext-pdo_mysql.ini:/usr/local/etc/php/conf.d/docker-php-ext-pdo_pgsql.ini:/usr/local/etc/php/conf.d/docker-php-ext-sodium.ini:/usr/local/etc/php/conf.d/docker-php-ext-xdebug.ini:/usr/local/etc/php/conf.d/docker-php-ext-zip.ini|3.5.0',
			],
		];
	}
